...
| Phase 3：逐 Provider 迁移 | 进行中，两个协议族已完成 | [05-phase-3-provider-migration-status.md](./05-phase-3-provider-migration-status.md)、[10-phase-3a-openai-compatible-native-adapters.md](./10-phase-3a-openai-compatible-native-adapters.md)、[14-phase-3b-responses-native-adapters.md](./14-phase-3b-responses-native-adapters.md) | 9 个 API 已使用原生 Adapter；其余 5 个 API 仍由 legacy bridge 接入 |
