...
- To recommend an option, add a badge like ["Recommended"] to it and make it the first option. You may add other short badges to signal trade-offs (e.g. "Faster", "Cheaper"). Badges are display-only guidance.
- Questions, options, and badges are user-facing copy: write them in the language of the user's latest message, not the language of these instructions. The examples above are English only because this description is.
