...
export function DocxPreview({ content }: DocxPreviewProps): JSX.Element {
	...
	return (
		<div
			className="docx-preview markdown-body break-words p-4 text-[13px] leading-[1.6] text-[var(--text-1)] [&_h1]:mb-3 [&_h1]:mt-4 [&_h1]:text-[18px] [&_h1]:font-bold [&_h2]:mb-2 [&_h2]:mt-3.5 [&_h2]:text-[16px] [&_h2]:font-bold [&_h3]:mb-2 [&_h3]:mt-3 [&_h3]:text-[14px] [&_h3]:font-semibold [&_img]:my-2 [&_img]:max-w-full [&_img]:rounded-md [&_ol]:my-1.5 [&_ol]:ml-4 [&_ol]:list-decimal [&_p]:my-1.5 [&_table]:my-2 [&_table]:w-full [&_table]:border-collapse [&_table]:text-[12px] [&_td]:border [&_td]:border-[var(--border)] [&_td]:px-3 [&_td]:py-1.5 [&_th]:border [&_th]:border-[var(--border)] [&_th]:px-3 [&_th]:py-1.5 [&_th]:font-semibold [&_ul]:my-1.5 [&_ul]:ml-4 [&_ul]:list-disc"
