...
import type { ShowcaseCanvasMotif } from "../../../detail/types";
...
function CanvasByMotif({ motif }: { motif: ShowcaseCanvasMotif }): JSX.Element {
	switch (motif) {
		case "design":
			return <DesignCanvas />;
		case "code":
...
export function ShowcaseChatOverCanvas({
	...
	return (
		<section
			...
			aria-label="capability-showcase-chat-over-canvas"
		>
