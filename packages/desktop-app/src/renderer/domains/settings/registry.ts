...
export const SETTINGS_TABS: readonly SettingsTabRegistration[] = [
	...
	{ key: "mcp", label: "MCP 服务器", labelKey: "tabMcp", icon: "icon-[mdi--server-outline]" },
	...
	{ key: "achievements", label: "成就", labelKey: "tabAchievements", icon: "icon-[solar--cup-star-linear]" },
	{ key: "pet", label: "桌宠", labelKey: "tabPet", icon: "icon-[mdi--paw-outline]" },
	{
		key: "permissions",
		label: "权限管理",
...
export const SETTINGS_SECTIONS = [
	...
	{ tab: "mcp", id: "mcp-server-list", title: "服务器列表", titleKey: "section_mcp-server-list" },
