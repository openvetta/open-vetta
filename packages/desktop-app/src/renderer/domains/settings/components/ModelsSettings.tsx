...
import type { ModelsConfigData, SubscriptionStatus, SubscriptionWindow } from "@preload/api.js";
...
const WINDOW_LABELS: Record<SubscriptionWindow["kind"], string> = {
	"5h": "5 小时窗口",
	week: "周窗口",
	month: "月窗口",
};
...
function formatResetCountdown(iso: string, now: number): string {
...
export function ModelsSettings(): JSX.Element {
	...
	// 打开设置页时拉取一次套餐状态（与远程 providers 对齐）。
	useEffect(() => {
