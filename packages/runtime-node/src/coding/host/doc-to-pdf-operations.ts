...
import type { CommandProcessPort, DesktopCommandResult } from "../shared/desktop-command.js";
import type { DocToPdfDetectedBackend, DocToPdfOperations } from "../tools/doc-to-pdf/doc-to-pdf-tool.js";
import { createNodeCommandProcessHost } from "./command-process.js";

const PROCESS_TIMEOUT_MS = 60_000;
const PROCESS_MAX_BUFFER_BYTES = 1024 * 1024;

export interface NodeDocToPdfOperationsOptions {
...
export function createNodeDocToPdfOperations(options: NodeDocToPdfOperationsOptions = {}): DocToPdfOperations {
