...
export interface GreenfieldToolAvailability {
...
export function resolveGreenfieldToolActivation(
	base: CodingToolActivation,
	context: ModelCallContributionContext,
	availability: GreenfieldToolAvailability,
	agentMode?: string,
	...
	if (isGreenfieldKnowledgeToolEnabled(base, context, availability.knowledgeAvailable)) {
		capabilities.add("knowledge");
	}
	return { ...base, capabilities, agentMode };
}

export function isGreenfieldKnowledgeToolEnabled(
	base: CodingToolActivation,
	context: ModelCallContributionContext,
