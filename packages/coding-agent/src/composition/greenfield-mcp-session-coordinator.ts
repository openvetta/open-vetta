...
export interface GreenfieldMcpSessionCoordinatorOptions {
	readonly source?: McpRuntimeToolSource;
	readonly registry: McpRuntimeToolRegistry;
	readonly indexes: GreenfieldMcpSessionIndexes;
}

export interface GreenfieldMcpSessionControllerOptions {
	readonly sessionId: string;
	readonly activation: CodingToolActivation;
	readonly pluginRuntime?: CodingAgentPluginMcpRuntime;
}

export interface GreenfieldMcpSessionCoordinator {
	readonly sharedRuntimeAvailable: boolean;
	createSessionController(options: GreenfieldMcpSessionControllerOptions): McpDeferredToolController | undefined;
...
export async function createGreenfieldMcpSessionCoordinator(
	options: GreenfieldMcpSessionCoordinatorOptions,
): Promise<GreenfieldMcpSessionCoordinator> {
