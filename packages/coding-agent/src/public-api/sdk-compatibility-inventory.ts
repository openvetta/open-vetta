...
export const SDK_SESSION_MEMBER_WIRING = {
	...
	subagents: "not-wired",
	listSubagents: "not-wired",
	interruptSubagent: "not-wired",
	clearFinishedSubagents: "not-wired",
	...
	reconfigureCustomTools: "not-wired",
	...
	steer: "wired",
	followUp: "wired",
	sendCustomMessage: "not-wired",
	sendUserMessage: "not-wired",
	clearQueue: "wired",
	...
	executeBash: "not-wired",
	recordBashResult: "not-wired",
	abortBash: "not-wired",
	isBashRunning: "not-wired",
	hasPendingBashMessages: "not-wired",
	switchSession: "not-wired",
	setSessionName: "wired",
	fork: "not-wired",
	navigateTree: "not-wired",
	switchBranch: "not-wired",
	appendBranchSummary: "not-wired",
	deleteMessage: "not-wired",
	replaceLastUserMessage: "not-wired",
	exportForkToNewFile: "not-wired",
	getUserMessagesForForking: "not-wired",
