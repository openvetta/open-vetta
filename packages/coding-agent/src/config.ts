...
export function getPackageDir(): string {
	// Bootstrap-time env lookup: avoid referencing ENV_PACKAGE_DIR before APP_NAME is initialized.
	const envDir = process.env.VETTA_PACKAGE_DIR || process.env.PI_PACKAGE_DIR;
	if (envDir) {
