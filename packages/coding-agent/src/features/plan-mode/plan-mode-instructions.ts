...
export function renderPlanModeInstructions(options: { readonly canSubmitPlan: boolean }): string {
	return [
		...
		"   - for something built from scratch, the software itself: platform and tech stack, feature set and depth, look and feel, content and assets. There is no code to settle these, so they are the user's call.",
