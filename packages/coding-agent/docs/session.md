...
- [`packages/coding-agent/src/model-context/message-types.ts`](../src/model-context/message-types.ts) - Extended message types (BashExecutionMessage, CustomMessage, etc.)
...
For TypeScript definitions in your project, inspect `node_modules/@vetta/coding-agent/dist/` and `node_modules/@vetta/ai/dist/`.
