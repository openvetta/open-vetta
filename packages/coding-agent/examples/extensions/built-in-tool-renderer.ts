...
import type { BashToolDetails, EditToolDetails, ExtensionAPI, ReadToolDetails } from "@vetta/coding-agent";
import { createBashTool, createEditTool, createReadTool, createWriteTool } from "@vetta/coding-agent";
