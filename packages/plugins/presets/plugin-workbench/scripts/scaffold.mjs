 ...
 * Usage: node scaffold.mjs <targetDir> --id <id> --name <displayName> [--semver-sdk ^0.1.1] [--semver-vite ^0.0.6]
 */
...
function parseArgs(argv) {
	...
	const out = { target: null, id: null, name: null, sdk: "^0.1.1", vite: "^0.0.6" };
	const rest = [...argv];
