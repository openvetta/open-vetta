 ...
 * Usage: node scaffold.mjs <targetDir> --id <id> --name <displayName> [--semver-sdk ^0.1.0] [--semver-vite ^0.0.3]
 */
...
function parseArgs(argv) {
	...
	const out = { target: null, id: null, name: null, sdk: "^0.1.0", vite: "^0.0.3" };
	const rest = [...argv];
