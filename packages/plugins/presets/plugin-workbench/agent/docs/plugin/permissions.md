...
| `ui.slot.activity-tab` | `registerActivityTab` / `openActivityTab` / `setActivityTabVisible` / `setActivityPanelWidth` | [ui-slots](./ui-slots.md#活动面板-tab-registeractivitytab) |
