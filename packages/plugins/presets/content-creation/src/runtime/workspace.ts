import { applyContentProjectCommands, type ContentProjectCommand } from "../domain/commands";
import { createContentProject, CONTENT_CREATION_SCHEMA_VERSION, type ContentProjectDocument } from "../domain/model";
import type { ContentProjectRepository } from "./project-repository";
