...
/** Minimal skill shape for rendering; host maps from full SkillInfo. */
export interface SlashPanelSkillItem {
	name: string;
	alias?: string;
	description?: string;
	type?: string;
...
export interface SlashPanelViewProps {
	...
	onSelectItem: (skill: SlashPanelSkillItem) => void;
}
