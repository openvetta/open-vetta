 ...
 */
export function ChatHeaderNewSessionButton({
	onClick,
	title: titleOverride,
	alwaysVisible = false,
}: {
	...
	if (!alwaysVisible && !sidebarCollapsed && !narrow) return null;

	const title = titleOverride ?? t("chatView.newSessionButton.title");
	return (
		<Button
			variant="ghost"
			size="icon-sm"
