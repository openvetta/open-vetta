...
export function TeamMemberReplyCard({ event, onOpen }: TeamMemberReplyCardProps): JSX.Element {
	...
	return (
		<div
			...
			className="flex max-h-[240px] min-h-0 w-full min-w-0 flex-col gap-2 overflow-hidden rounded-xl border border-border/40 bg-card/30 px-3 py-3 text-left"
		>
			...
			<span className="ml-6 flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto rounded-lg bg-muted/20 px-3 py-2">
