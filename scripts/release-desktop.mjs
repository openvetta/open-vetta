...
const DESKTOP_PACKAGE_PATH = "apps/desktop-app/package.json";
const DESKTOP_CHANGELOG_PATH = "apps/desktop-app/CHANGELOG.md";
...
run("bun", ["run", "--cwd", "apps/desktop-app", "typecheck"]);
