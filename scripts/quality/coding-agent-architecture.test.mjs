...
describe("Coding Agent architecture gate", () => {
	...
	it("keeps terminal CLI behavior in cli-app", () => {
		...
		expect(findCodingAgentArchitectureViolations(sourceViolation)).toEqual(
			expect.arrayContaining([
				`${cliControlPath}: terminal CLI behavior belongs to cli-app`,
				`${processSessionHostPath}: terminal CLI behavior belongs to cli-app`,
